...
const Filter = ({
  ...
  return (
    <div className="border rounded-radius-lg border-muted flex flex-col lg:flex-row items-center gap-4 justify-between lg:items-center lg:px-6 px-3 py-4 bg-on-surface ">
